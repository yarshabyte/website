...
export const resultCases = [
  {
    ...
    prefix: "+",
    metric: "Engagement",
    tone: "from-accent/30 via-sky/20 to-background/10",
  },
  {
    name: "GreenLeaf Cafe",
    stat: "224",
    ...
    prefix: "+",
    metric: "Sessions",
    tone: "from-blue/25 via-accent/15 to-background/10",
  },
  {
    ...
    prefix: "+",
    metric: "Conversions",
    tone: "from-sky/25 via-accent/20 to-background/10",
  },
  {
    name: "Studio Naya",
    stat: "120",
    suffix: "sec",
    prefix: "",
    metric: "Avg. visit dur.",
    tone: "from-accent/20 via-blue/15 to-background/10",
  },
] as const;

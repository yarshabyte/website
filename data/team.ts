...
export const teamMembers = [
  {
    ...
    email: "member01@yarshabyte.com",
    intro: "Shapes the visual direction, brand systems, and creative standard behind every Yarsha Byte project.",

# Aashish Chapagain — CEO Portfolio | YarshaByte

Standalone web application and portfolio for **Aashish Chapagain** (Chief Executive Officer at YarshaByte), designed to mirror the design system, typography, and styling of [yarshabyte.com](https://yarshabyte.com).
...
3. Set **Root directory** to `aashish`.
4. Build command: `npm run build`.
5. Output directory: `dist`.
6. Add custom domain: `aashish.yarshabyte.com`.

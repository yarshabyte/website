...
function DecorativeMark() {
  return (
    <svg
      viewBox="0 0 40 56"
      className="h-12 w-9 text-background/80"
      fill="none"
      aria-hidden="true"
    >
      <path d="M10 10v36M20 18v20M30 10v36" stroke="currentColor" strokeWidth="1" />
      <path
        d="m10 2 3.5 2v4L10 10 6.5 8V4L10 2Zm20 44 3.5 2v4L30 54l-3.5-2v-4l3.5-2Z"
        stroke="currentColor"
        strokeWidth="1"
      />
    </svg>
...
export function ContactSection() {
  return (
    <footer id="contact" className="relative bg-background p-3 sm:p-4">
      <div className="relative min-h-dvh overflow-hidden rounded-[1.75rem] bg-foreground px-5 py-6 text-background sm:px-8 sm:py-8 lg:min-h-[calc(100vh-2rem)] lg:px-12 lg:py-10">
        <div className="pointer-events-none absolute -right-36 -top-40 size-[31rem] rounded-full border border-background/8" />
        <div className="pointer-events-none absolute -bottom-52 -left-40 size-[32rem] rounded-full border border-background/8" />

        <div className="relative mx-auto flex min-h-[calc(100dvh-4rem)] w-full max-w-[112rem] flex-col">
          <div className="flex items-start justify-between">
            <Link
              href="/"
              aria-label={`${contactData.companyName} home`}
            ...
            >
              <Image
                src="/logo-icon.png"
                alt={`${contactData.companyName} logo`}
                width={56}
                height={56}
                className="size-11 rounded-md bg-white object-contain p-1 sm:size-12"
              />
              <span className="hidden text-xs font-semibold uppercase tracking-[0.2em] text-background/72 sm:block">
          ...
          <Link
            href="/contact"
            className={`${displayLinkClass} mx-auto mt-8 text-center text-[clamp(4rem,11vw,10.5rem)] sm:mt-4`}
          >
            Let&apos;s talk
            <AccentMark />
          </Link>

          <div className="mt-8 h-px w-full bg-background/42 lg:mt-10" />
          ...
          <div className="grid flex-1 gap-12 py-10 lg:grid-cols-[0.95fr_0.65fr_1.4fr] lg:items-center lg:gap-8 lg:py-8">
            <div className="flex flex-col items-start">
              ...
              <div className="mt-8 grid gap-5 text-sm font-semibold leading-6 text-background/72 lg:mt-12">
            ...
            <nav
              ...
              className="grid content-center gap-2 border-y border-background/14 py-8 text-sm font-semibold uppercase tracking-[0.035em] text-background/78 lg:border-y-0 lg:py-0"
            >
          ...
          <div className="mx-auto h-px w-full bg-background/42 lg:w-[62%]" />
          ...
          <div className="grid gap-10 pt-9 lg:grid-cols-[1fr_auto_1fr] lg:items-end lg:gap-12">
            ...
            >
              <label
                ...
                className="text-xs font-semibold uppercase tracking-[0.18em] text-background/58"
              >
                Newsletter
              </label>
              <div className="mt-5 flex min-h-12 items-center border-b border-background/58">
                <input
                  id="footer-email"
                  name="email"
                  type="email"
                  ...
                  className="min-w-0 flex-1 bg-transparent py-3 text-base text-background outline-none placeholder:text-background/42"
                />
                <button
                  type="submit"
            ...
            <div className="grid justify-items-start lg:justify-items-center">
              ...
              <p className="mt-6 text-xs font-semibold uppercase tracking-[0.12em] text-background/48">
